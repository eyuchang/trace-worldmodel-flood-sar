...
| 03:55 | Is my computer ready? | Run `python workshop.py check` | Five plain-language PASS lines |
| 04:50 | What does the simulator produce? | Scenario summary and saved decision path | Explain the three event counts |
...
| 13:55 | What did I learn? | Replay result and four-item checklist | End with two byte-identical results |
...
Use a separately prepared solved exercise for the later shots. Do not record or
