"""Reduced-order meteorology, hydrology, and crossing-state generation."""
...
def _select_by_id(items: list[object], allowed_ids: Sequence[str], attribute: str) -> list[object]:
